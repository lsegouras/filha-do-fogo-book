  ...
  var has3d,
    ...
    turnMethods = {
      ...
      init: function (opts) {
        ...
        if (opts.when)
          for (i in opts.when) if (has(i, opts.when)) this.bind(i, opts.when[i])
        ...
        var data = this.data().f,
          ...
          gradient =
            ...
            (!turn ||
              ...
              (data.opts.page != 2 &&
                data.opts.page != turn.data().totalPages - 1))
